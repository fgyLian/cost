	...
	<form action="expense/myExpense" id="f1" method="post" class="form-inline">
		<div class="row alert alert-info" style="margin: 0px; padding: 5px;">
			...
			<select class="form-control" name="expenseState">
				...
				<option value="-2" ${expense.expenseState=='-2'?'selected':''}>经理审核未通过</option>
		...
		<div class="row" style="padding: 15px;">
			<d:table class="table table-hover table-condensed" name="expenseList" pagesize="10" requestURI="expense/myExpense">
				...
				<d:column property="oparate" title="操作"></d:column>
