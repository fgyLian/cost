				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						...
						<ul
							...
							<li><a href="system/myInfo"  target="mainframe"> <i class="icon-user"></i> 个人资料
							</a></li>

							<li class="divider"></li>

							<li><a href="view/login.jsp"> <i class="icon-off"></i> 退出</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
						...
						<c:if test="${parent.pMenuId==0 }">
						    <li><a href="javascript:void(0)" target="mainframe"
									class="dropdown-toggle"> <i class="icon-desktop"></i> <span
										class="menu-text"> ${parent.menuName } </span> <b class="arrow icon-angle-down"></b>
								</a>
