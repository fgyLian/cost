...
<body>
	...
	<form action="expense/managerAudit" id="f1" method="post"
	...
	<h5 class="page-header alert-info" style="margin: 0px; padding: 10px; margin-bottom: 10px;">经理审核</h5>
				 ...
				 <div class="form-group">
				    ...
				    <div class="col-xs-9">
				    	...
				    	<input type="radio" checked="checked" name="auditState" value="2"/>经理审核通过
				    	 ...
				    	 <div class="radio">
				    	 <label>
				  	 	<input type="radio" name="auditState" value="-2"/>经理审核不通过
				  	 	</label>
				  	 	</div>
		...
		<div class="row">
			<div class="col-sm-7" align="center">
				...
				<a href="expense/expenseQuery" class="btn btn-warning">返回上一级</a>
			</div>
		</div>
	</form>
